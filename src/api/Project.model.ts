type TProjectName = "Circles Web" | "Circles Server" | "Circles Express" | null;
...
class Project {
    ...
    constructor(name: TProjectName, description: string, url: string, repo_url?: string, logoUrl?: string) {
        this.name = name;
