...
const Header = (props: ComponentProps) => {
    ...
    return <Box className={cx(classes.root, props.className)} style={props.style} display="flex" justifyContent="space-between" alignItems="center">
        ...
        <Hidden smDown>
            <Box display="flex" justifyContent="flex-end" alignItems="center" className={cx(classes.side)} style={{ height: "100vh" }} overflow="hidden" >
                <div>
                    ...
                    <Box display="flex" alignItems="center" justifyContent="center" className={cx(classes.planet, classes.earthContainer)}>
